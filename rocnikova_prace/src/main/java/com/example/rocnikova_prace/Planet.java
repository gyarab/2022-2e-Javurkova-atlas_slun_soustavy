...
import java.util.Objects;
    ...
    /**
     * Třída Planet je potomek třídy Sphere, takže dědí její vlastnosti.
     *
     * Prvně vytvořím proměnné potřebné pro vytvoření planety/Slunce.
     ...
     *
     * Vytvořím proměnnou m typu PhongMaterial do které podle aktuálního objektu Planet ukládám její "kabát".
     ...
     *
     * Metoda rotate() se stará o to aby se všechny objekty Planet rotovaly svojí vlastní rychlostí.
     * Všechny mají stejný rotační bod s hodnotou 0 v X,Z a 1 v Y - tedy rotují podle osy Y.
